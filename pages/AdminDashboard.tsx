        ...
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage scholarships and ambassadors</p>
            </div>
            <button 
        ...
        {activeTab === 'scholarships' ? (
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="p-6 border-b">
              ...
              <p className="text-gray-500 text-sm mt-1">{ambassadors.length} active ambassadors</p>
            </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {ambassadors.map((ambassador) => (
                     <tr key={ambassador.$id}>
                       <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{ambassador.fullName || 'Anonymous'}</td>
                       <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{ambassador.email}</td>
                       <td className="px-6 py-4 whitespace-nowrap text-sm font-mono text-blue-600">{ambassador.referralCode}</td>
                       <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-bold">{ambassador.referralCount || 0}</td>
                     </tr>
                  ))}
                </tbody>
              </table>
